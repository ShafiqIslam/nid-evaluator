...
class Naive(ClassifierStrategy):
    MINI_BATCH_SIZE = 30
    EPOCHS = 10
    NO_OF_OUTPUT_NEURONS = 3
    ...
    def set_network_layers(self, sizes: list):
        ...
        sizes.append(self.NO_OF_OUTPUT_NEURONS)
    ...
    def classify(self) -> Optional[NIDFormat]:
        output = self.stochastic_gradient_descent()
        if output == 1:
            return None
        if output == 2:
            return NIDFormat.SMART
        if output == 1:
            return NIDFormat.CASUAL
    ...
    def stochastic_gradient_descent(self):
        ...
        for j in xrange(self.EPOCHS):
            ...
            mini_batches = [
                self.training_dataset[k:k + self.MINI_BATCH_SIZE]
